...
class RiskSignalDecompositionTests(unittest.TestCase):
    ...
    def test_contributions_sum_to_trust_score(self):
        result = decompose_risk_signals(
            _make_seller(late_delivery_rate=0.2, average_review_score=3.5)
        )
        total_contribution = (
    ...
    def test_weakest_signal_identified(self):
        result = decompose_risk_signals(
            _make_seller(late_delivery_rate=0.8, average_review_score=5.0, negative_review_rate=0.0, cancellation_rate_proxy=0.0)
        )
    ...
    def test_output_contains_all_columns(self):
        ...
        expected_cols = [
            ...
            "delivery_raw", "review_raw", "cancellation_raw", "negative_review_raw",
            "delivery_contribution", "review_contribution",
            "cancellation_contribution", "negative_review_contribution",
            "weakest_signal",
        ]
